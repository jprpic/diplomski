                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <div class="flex w-full">
                            ...
                            <div class="w-2/3 flex flex-col flex-none mr-2">
                                ...
                                <div class="mt-6">
                                    <div class="flex flex-col">
                                        ...
                                        >
                                            <div
                                                class="p-2 border border-gray-200 rounded-md shadow-md bg-gray-50"
                                                v-if="
                                                    experience.type ===
                                                    'employment'
                                                "
                                            >
                                                ...
                                                <ul class="ml-8 list-disc">
                                                    <li
                                                        v-for="result in experience.results"
                                                    >
                                                        {{ result }}
                                                    </li>
                                                </ul>
                                        ...
                                        >
                                            <div
                                                class="mb-2 p-2 border border-gray-200 rounded-md shadow-md bg-gray-50"
                                                v-if="
                                                    experience.type ===
                                                    'education'
                                                "
                            ...
                            <div class="ml-2 flex flex-col grow">
                                <!--  Contacts  -->
                                <div
                                    class="p-4 flex flex-col w-full bg-gray-400 rounded-lg border border-gray-600/75 shadow-lg"
                                >
                                    <div
                                ...
                                >
                                    ...
                                    <ul v-for="skill in sortedSkills">
                                        ...
                                        >
                                            <span
                                                class="mr-1 truncate hover:whitespace-normal"
                                                :class="
                                                    getSkillClass(
                                                        getSkillType(
                                                            skill.skill_id
                                            ...
                                            >
                                            <img
                                                v-for="n in skill.proficiency"
                                                alt="star icon"
                                                :src="'/images/star_black.png'"
                                                class="pb-1 object-contain h-4 w-4"
                                            />
                                            <img
                                                v-for="n in 5 -
                                                skill.proficiency"
...
export default {
    ...
    computed: {
        sortedSkills() {
            return this.CV.skill_proficiencies.sort((a, b) => {
    ...
    methods: {
        getContactName(contact_id) {
            return this.CV.contact_info.find(
