                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div class="flex flex-row w-full">
                                ...
                                <div class="w-1/2 ml-2">
                                    <BreezeLabel for="img_url" value="Company picture url" />
                                    <BreezeInput id="img_url" type="url" class="mt-1 block w-full" required
                                                 :value="orgCv.img_url"
                            ...
                            <div class="mt-2">
                                <BreezeLabel for="description" value="About us" />
                                <BreezeTextArea id="description" rows="3" :value="orgCv.description" @input="updateDescription($event.target.value)" required />
                            </div>
...
export default {
    ...
    beforeUpdate() {
        ...
        if(usePage().props.value.auth.orgCv){
            ...
            if(!orgCv.id || (orgCv.id && orgCv.id !== JSON.parse(usePage().props.value.auth.orgCv).id)){
